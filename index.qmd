...
Proofbound makes it easy to write a <span class="typing-text">200-page book</span> and publish it online — in minutes!
</p>
...
function createBackgroundElements() {
    ...
    function createElement() {
        ...
        // Randomly choose between icon and word
        if (Math.random() < 0.7) {
...
// Stripe Integration
const stripe = Stripe('pk_test_51MPasYFVqC8fbxB6I1qKcWMOsSmaeC01Jj5mDS338M7R1IHktUdh3wReovg6BGKsPH8b0Hl3s6m2lHwfdJ2kue3v00N0ZT6GhC');
...
checkoutButton.addEventListener('click', async () => {
    try {
        const response = await fetch('https://proofbound-stripe.netlify.app/.netlify/functions/create-checkout-session', {
            ...
            body: JSON.stringify({
                priceId: 'price_1RUbGMFVqC8fbxB65a0ANhrl',
